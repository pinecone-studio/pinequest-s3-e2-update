  ...
  return (
    ...
    >
      ...
      <section className="rounded-xl border border-zinc-200 bg-white shadow-sm">
        ...
        <div className="hidden grid-cols-[84px_minmax(200px,1fr)_minmax(180px,1fr)_130px_100px_100px_100px] items-center gap-3 border-b border-zinc-100 bg-zinc-50 px-6 py-3 lg:grid">
