        ...
        <section className="mt-8 grid min-h-0 items-start gap-6 sm:mt-12 sm:gap-8 lg:mt-16 lg:grid-cols-[1.05fr_0.95fr] lg:items-stretch lg:gap-10">
          <div className="max-w-xl min-w-0 lg:max-w-[47.5rem]">
            <header className="inline-flex w-full items-center justify-center gap-2 sm:justify-start">
              ...
              />
              <p className="text-[22px] font-black tracking-wider text-[#11161d]">
                UPDATE
              </p>
            </header>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3 sm:mt-12 sm:gap-4">
              ...
              <p className="max-w-[20rem] text-balance text-sm font-medium tracking-wider leading-snug text-[#122459] sm:max-w-none sm:text-base">
                10,000+ сурагч, багш ашиглаж байна
              </p>
            </div>

            <h1 className="mt-6 text-balance text-[clamp(1.625rem,4.5vw,2.625rem)] tracking-wider font-semibold leading-[1.35]  text-[#122459] sm:mt-8 lg:mt-10">
              Шалгалтын нэгдсэн
              <br />
              платформ
            </h1>
            <p className="mt-4 max-w-xl text-base font-medium tracking-wider leading-relaxed text-[#122459] sm:mt-5 sm:text-lg lg:text-xl">
              Шалгалт бэлтгэх, авах, үнэлэх бүх процессыг <br />
            ...
            <article className="mt-10 w-full max-w-lg rounded-[14px] border border-[#D7ECFF] bg-[#D7ECFF] p-4 transition hover:border-[#D7ECFF] sm:mt-12 sm:p-6 lg:mt-14 lg:max-w-[31.25rem] lg:min-h-[15rem]">
              <div className="flex flex-col items-center gap-4 sm:flex-row sm:items-start sm:gap-5">
                ...
                <div className="min-w-0 text-center sm:text-left">
                  <p className="text-lg font-semibold leading-tight tracking-wider text-[#481C00] sm:text-xl md:text-2xl">
                    Багш: Ц. Ангараг
                  </p>
                  <p className="mt-1 text-base tracking-wider font-medium text-[#122459] sm:text-lg">
                    16-р сургууль
                  </p>
                  <div className="mx-auto mt-3 h-px max-w-xs bg-[#c8c4a8] sm:mx-0 sm:max-w-[19.5rem]" />
                </div>
              </div>
              <p className="mt-4 text-balance text-base leading-snug tracking-wider font-medium text-[#122459] sm:text-lg">
                Шалгалт авах процесс ойлгомжтой болсон.
                <br />
                Цаг хэмнэж, сурагчдаа үр дүнтэй хянах
                <br />
                боломж бүрдсэн.
              </p>
            </article>
          ...
          <div className="mt-6 flex w-full min-w-0 flex-col lg:mt-2 lg:min-h-full lg:justify-between lg:pl-4 xl:pl-10">
            ...
            <div className="mt-4 flex w-full max-w-full flex-col items-center gap-4 sm:mt-6 sm:flex-row sm:items-end sm:justify-start sm:gap-2 md:gap-3 lg:mt-2 lg:justify-start lg:gap-1">
              ...
              <div className="mb-2 flex w-full max-w-md flex-col gap-3 sm:max-w-none sm:flex-row sm:flex-wrap sm:items-stretch sm:justify-center sm:gap-4 lg:w-auto lg:max-w-none lg:flex-nowrap lg:justify-start">
                ...
                <Link
                  href="/teacher"
                  className="inline-flex h-14 w-full min-w-0 shrink-0 tracking-wider items-center justify-center rounded-xl border border-[#7DC8FF] bg-white px-5 text-xl font-medium text-[#122459] transition hover:bg-[#f7fbff] sm:h-17.5 sm:w-auto sm:min-w-40 sm:px-6 sm:text-2xl lg:text-[30px]"
                >
                  Багш
                </Link>
              </div>
