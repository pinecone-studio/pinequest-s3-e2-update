  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-950/40 p-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl">
        <h3 className="text-lg font-semibold text-zinc-900">Шалгалтын хуваарь устгах уу?</h3>
        <p className="mt-2 text-sm text-zinc-600">
          <span className="font-medium text-zinc-900">{schedule.subject}</span> хичээлийн{" "}
          <span className="font-medium text-zinc-900">{schedule.className}</span> ангийн
          шалгалтыг устгах гэж байна. Энэ үйлдлийг буцаах боломжгүй.
        </p>
