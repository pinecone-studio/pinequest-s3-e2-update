    ...
    <div className="space-y-10">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-600">
          Багш нэмэх, засах, хасах. Мэргэжил, заадаг хичээлийг (жишээ нь: Нийгэм,
          Математик) заавал биш ч жагсаалтад харагдана. Хасагдсан багш бүх ангийн
          хуваарилалтас автоматаар авна.
        </p>
      </div>
              ...
              <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                ...
                >
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <label className={`${labelClass} md:col-span-2 lg:col-span-1`}>
                      Мэргэжил / хичээл
                      <input
                        name="specialty"
