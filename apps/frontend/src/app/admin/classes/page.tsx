...
import { createClass } from "@/app/admin/action";
    ...
    <div className="space-y-10">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-600">
          Анги үүсгэж, багш хуваарилаад, сурагчдыг удирдахын тулд ангиа нээнэ үү.
        </p>
      </div>
      ...
      <section className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm">
        ...
        <form action={createClass} className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-end">
          <label className="block flex-1">
            <span className="text-xs font-medium text-zinc-500">Ангийн нэр</span>
            <input
              name="name"
              required
