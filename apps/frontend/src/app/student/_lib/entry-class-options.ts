/** Legacy short ids — зөвхөн хуучин localStorage + нэвтрэхүйн нэр тааруулахад. */
export type StudentEntryClass = {
  id: string;
  name: string;
  grade: string;
  studentCount: number;
...
export const STUDENT_ENTRY_CLASS_OPTIONS: StudentEntryClass[] = [
  ...
  { id: "c-9b", name: "9B", grade: "9-р анги", studentCount: 30 },
  { id: "c-10a", name: "10A", grade: "10-р анги", studentCount: 34 },
  { id: "c-10b", name: "10B", grade: "10-р анги", studentCount: 33 },
  { id: "c-11a", name: "11A", grade: "11-р анги", studentCount: 30 },
