      ...
      <section>
        <article className="rounded-2xl p-6 shadow-[0_2px_12px_rgba(31,42,68,0.06)] sm:p-8">
          <header className="mb-6 border-b border-[#eef2f6] pb-6">
            <h2 className="text-[22px] font-extrabold tracking-wider text-[#1f2a44]">
              Миний ангиуд
            </h2>
            ...
            <p className="mt-2 max-w-2xl tracking-[1px] text-4 leading-relaxed text-[#4a5875]">
              Анги дээр дарж сурагчид, шалгалтын статистик руу орно.
            </p>
            <p className="mt-3 inline-flex items-center gap-2 tracking-wider rounded-lg px-3 py-1.5 text-3 font-semibold text-[#1f2a44]">
