...
export default function TeacherLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#eef3f9] text-[#1f2a44]">
        ...
        <aside className="flex w-[320px] shrink-0 flex-col border-r border-[#d9dee8] bg-white">
          <div className="border-b border-[#e5eaf2] p-6">
            <div className="flex items-center gap-4">
              <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[#5fa9f3] to-[#3f8fe8] text-white shadow-md">
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-3 rounded-full px-4 py-3 transition ${
                    isActive
                      ? "bg-[#4f95ea] text-white shadow-sm"
                      : "text-[#2f3c59] hover:bg-[#f1f5fb]"
                  }`}
                >
                  <Icon
                    className={`h-5 w-5 ${isActive ? "text-white" : "text-[#4f95ea]"}`}
                  />
