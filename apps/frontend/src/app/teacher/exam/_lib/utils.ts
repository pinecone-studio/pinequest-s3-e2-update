...
export const inputClassName =
  "h-12 w-full rounded-2xl border border-[#d3deef] bg-white px-4 text-sm text-[#183153] outline-none transition placeholder:text-[#A1A1A1] data-[placeholder]:text-[#A1A1A1] focus:border-[#4f9dff] focus:ring-4 focus:ring-[#4f9dff]/10";
