                ...
                <div className="flex w-full items-center justify-between gap-3 rounded-2xl border border-[#cfe8ff] bg-gradient-to-br from-[#eef7ff] via-white to-[#f5f9ff] px-3 py-2.5 shadow-[0_4px_24px_rgba(29,111,235,0.08)]">
                  ...
                  <div className="flex shrink-0 items-center gap-2">
                    <button
                      ...
                      aria-label={
                        mobileNavOpen ? "Цэс хаах" : "Үндсэн цэс нээх"
                      }
                ...
                <div className="min-w-0">
                  ...
                  >
                    <Image
                      ...
                      priority
                    />
                    <h1 className="mt-2 text-[22px] font-semibold leading-[100%] tracking-[1px] text-[#171717]">
                      UPDATE
                    </h1>
                  </Link>
                </div>
                    ...
                    {menuItems.map((item) => {
                      ...
                      return (
                        <li key={item.href}>
                          <Link
                            href={item.href}
                            className={`inline-flex h-[35px] items-center rounded-[6px] px-[12px] py-[6px] text-[18px] font-semibold tracking-[2px] leading-[23px] text-[#262626] transition-colors ${
                              active
