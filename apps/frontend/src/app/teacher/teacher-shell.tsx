					...
					<div className="mx-auto max-w-[1400px] px-4 py-3 lg:px-6">
						<div className="flex items-center gap-8 justify-between">
							<div className="flex min-w-0 items-center gap-4">
								<Link
									href="/teacher"
									className="relative block h-16 w-16 shrink-0 overflow-hidden rounded-3xl bg-white shadow-[0_6px_20px_rgba(31,42,68,0.12)] outline-none transition hover:opacity-90 focus-visible:ring-2 focus-visible:ring-[#4f9dff] focus-visible:ring-offset-2"
