    ...
    <main className="mx-auto w-full max-w-6xl space-y-5 px-4 py-8">
      <section className="rounded-2xl border border-[#d9dee8] bg-white p-5">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            <button
              className="flex h-10 w-10 items-center justify-center rounded-full bg-[#d7ebff] text-4 text-[#4ea4f1]"
              type="button"
            >
              ‹
            </button>
            ...
            <div>
              <p className="text-4 font-extrabold">Батбаяр Доржсүрэн</p>
              <p className="text-4 text-[#44506a]">batbayar@school.mn</p>
            </div>
          </div>

          <div className="ml-auto flex items-center gap-4">
            <span className="text-4 font-bold">1/6</span>
            <button
              className="flex h-10 w-10 items-center justify-center rounded-full bg-[#d7ebff] text-4 text-[#4ea4f1]"
              type="button"
            >
      ...
      <section className="grid grid-cols-1 gap-5 lg:grid-cols-2">
        <article className="rounded-2xl border border-[#d9dee8] bg-white p-6">
          <p className="mb-4 text-4 font-bold">Асуулт: 1</p>
          <p className="text-4 font-medium leading-relaxed">
        ...
        <div className="lg:pl-2">
          <button
            className="w-full rounded-2xl bg-[#4ca3f0] px-6 py-6 text-4 font-bold text-white transition hover:bg-[#3996ea]"
            type="button"
          >
            AI-аар шалгах
          </button>
      ...
      <section className="max-w-3xl rounded-2xl border border-[#d9dee8] bg-white p-6">
        <p className="mb-4 text-4 font-bold">Сурагчийн хариулт</p>
        ...
        <p className="mt-4 text-4 text-[#61749a]">
          Илгээсэн: 3/20/2026, 6:30:00 PM
        </p>
      </section>

      <button
        className="flex w-full max-w-3xl items-center justify-center gap-3 rounded-2xl border border-[#d9dee8] bg-white py-5 text-4 font-medium text-[#2f3c59] transition hover:bg-[#f7f9fc]"
