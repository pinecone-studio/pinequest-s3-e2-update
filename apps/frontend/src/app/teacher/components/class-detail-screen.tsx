      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="text-4 text-[#64748b]">
            Үүсгэсэн ангиуд, сурагчдын жагсаалт
          </p>
        </div>
      </div>
      ...
      <section className="rounded-xl border border-[#d9dee8] bg-white p-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              className="rounded-xl border border-[#d9dee8] bg-white px-4 py-2.5 text-4 font-semibold text-[#4f9dff] transition hover:bg-[#f8fafc]"
              type="button"
            >
              Шалгалт үүсгэх
            </button>
                ...
                <tr key={student.id} className="border-b border-[#e2e8f0]">
                  ...
                  <td className="py-3">
                    <button
                      ...
                      className="text-4 font-semibold text-[#4f9dff] hover:underline"
                      type="button"
                    >
                      Үр дүн харах
                    </button>
        ...
        <div className="mt-6">
          ...
          <button
            ...
            type="button"
          >
            <FileText className="h-5 w-5 text-[#4f9dff]" />
