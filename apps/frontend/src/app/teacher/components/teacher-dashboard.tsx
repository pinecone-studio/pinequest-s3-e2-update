      ...
      <section className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <article className="rounded-xl border-l-4 border-l-[#f59e0b] border border-[#d9dee8] bg-white p-4">
          ...
          <button
            ...
            className="mt-3 rounded-xl bg-[#4ca3f0] px-4 py-2 text-4 font-semibold text-white transition hover:bg-[#3996ea]"
            type="button"
          >
            Засах
          </button>
        ...
        <article className="rounded-xl border border-[#d9dee8] bg-white p-4">
          <div className="space-y-2">
            ...
            <div className="h-2 w-full rounded-full bg-[#e2e8f0]">
              <div className="h-2 w-[56%] rounded-full bg-[#4ca3f0]" />
            </div>
        ...
        <article className="rounded-xl border border-[#d9dee8] bg-white p-4">
          <div className="flex items-start gap-3">
            <Calendar className="h-6 w-6 shrink-0 text-[#4ca3f0]" />
            <div>
        ...
        <article className="rounded-xl border border-[#d9dee8] bg-white p-5 lg:col-span-2">
          <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-[#4ca3f0] px-4 py-2 text-4 font-semibold text-white transition hover:bg-[#3996ea]"
              type="button"
            >
          ...
          <div className="rounded-lg border border-[#e2e8f0] bg-[#f8fafc] p-4">
            ...
            <div className="mt-3 flex items-center gap-3">
              <div className="h-2 flex-1 max-w-[180px] rounded-full bg-[#e2e8f0]">
                <div
                  className="h-2 rounded-full bg-[#4ca3f0]"
            ...
            <button
              onClick={() => router.push("/teacher/shalgalt")}
              className="mt-4 rounded-xl bg-[#4ca3f0] px-5 py-2.5 text-4 font-semibold text-white transition hover:bg-[#3996ea]"
              type="button"
            >
              Үргэлжлүүлэх
            </button>
