    ...
    <div className="hidden space-y-[18px]">
      <section className="flex w-full flex-col gap-4 sm:flex-row sm:items-center sm:justify-between sm:gap-6">
        <div className="min-w-0">
          <h1 className="text-[17px] font-bold uppercase leading-snug tracking-[6%] text-[#122459] sm:text-[23px] sm:leading-[28px] sm:tracking-[0.1em]">
            БАГШИЙН АСУУЛТЫН САН
          </h1>
          <p className="mt-2 text-[14px] leading-[18px] font-medium tracking-[6%] text-[#737373] sm:mt-[8px] sm:text-[14px] sm:tracking-[0.1em]">
      ...
      <section className="rounded-[12px] border border-[#E5E5E5] bg-[#FAFAFA] px-4 py-5 sm:px-[26px] sm:py-[22px]">
        <h1 className="text-[28px] font-medium tracking-[4%] leading-[120%] text-[#323232] sm:text-[40px] sm:leading-none md:text-[53px] md:leading-[53px]">
          Сонголтын хэсэг
        </h1>
