  ...
  return (
    <div className="rounded-3xl border border-dashed border-[#c7d8ef] bg-[#f8fbff] p-10 text-center">
      <div className="mx-auto max-w-md">
        ...
        <h3 className="mt-3 text-2xl font-bold text-[#183153]">
          Таны асуултын сан дараагийн чанартай асуултаа хүлээж байна.
        </h3>
        <p className="mt-2 text-sm leading-6 text-[#637690]">
          Шүүлтүүрээ өөрчлөх эсвэл шинэ асуулт үүсгээд дараагийн шалгалтууддаа
          дахин ашиглах контентоо бүрдүүлж эхлээрэй.
        </p>
        <button
