...
CREATE UNIQUE INDEX `student_studentCode_unique` ON `student` (`studentCode`);--> statement-breakpoint
ALTER TABLE `school` ADD `provinceOrCity` text NOT NULL DEFAULT '-';--> statement-breakpoint
ALTER TABLE `school` ADD `soumOrDistrict` text NOT NULL DEFAULT '-';