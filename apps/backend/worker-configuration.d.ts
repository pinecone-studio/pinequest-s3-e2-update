/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: f2d96c943e72f0a8811d88dd355eb548)
// Runtime types generated with workerd@1.20260329.1 2026-03-23 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ExamMonitorRoom";
	}
	interface Env {
		...
		EXAM_MONITOR_ROOM: DurableObjectNamespace<import("./src/index").ExamMonitorRoom>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "CLERK_WEBHOOK_SIGNING_SECRET" | "EXAM_TOKEN_SECRET">> {}
}
